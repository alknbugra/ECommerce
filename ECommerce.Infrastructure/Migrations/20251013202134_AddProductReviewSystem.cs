...
{
    /// <inheritdoc />
    public partial class AddProductReviewSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductReviews_Users_ApprovedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReviewResponses_ProductReviews_ReviewId",
                        column: x => x.ReviewId,
                        principalTable: "ProductReviews",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ReviewResponses_Users_ApprovedByUserId",
                        column: x => x.ApprovedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ReviewResponses_Users_RespondedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductReviews_ApprovedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewImages_SortOrder",
                table: "ReviewImages",
                column: "SortOrder");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewResponses_ApprovedByUserId",
                table: "ReviewResponses",
                column: "ApprovedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewResponses_CreatedAt",
                table: "ReviewResponses",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewResponses_RespondedByUserId",
                table: "ReviewResponses",
